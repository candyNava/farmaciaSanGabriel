 ...
 */
public class FromProducto  /*javax.swing.JFrame */extends javax.swing.JInternalFrame {
    ...
    public FromProducto() {
        ...
        tablaVista.setModel(tbProductoV);
             tbProductoV.addColumn("Código");
             tbProductoV.addColumn("Producto");
             tbProductoV.addColumn("Precio");
...
/*public DefaultTableModel cargarCliente() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jtfCategoria1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 390, 100, 40));

        jtfCantidad.setFont(new java.awt.Font("Candara", 0, 21)); // NOI18N
        jPanel1.add(jtfCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 380, 140, 50));
