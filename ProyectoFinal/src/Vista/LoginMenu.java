...
public class LoginMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlbIconoUsrG = new javax.swing.JLabel();
        jlbiconoPassw = new javax.swing.JLabel();
        jlbMusica1 = new javax.swing.JLabel();
        jlbCalculadora1 = new javax.swing.JLabel();
        jlbiconoUserC = new javax.swing.JLabel();
        jtfUSR = new javax.swing.JTextField();
        jpwPSW = new javax.swing.JPasswordField();
        separadorContrasena = new javax.swing.JLabel();
        ...
        jlMinimizar.setFont(new java.awt.Font("Calibri Light", 1, 60)); // NOI18N
        jlMinimizar.setForeground(new java.awt.Color(51, 51, 51));
        jlMinimizar.setText("-");
        ...
        panelSuperior.add(jlMinimizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 0, 30, 20));
        ...
        panelSuperior.add(jlMaximizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 0, 30, 20));

        jPanel5.setBackground(new java.awt.Color(102, 102, 102));
        panelSuperior.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 580, 10));

        menu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_Menu_32px.png"))); // NOI18N
        panelSuperior.add(menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 40, 30));
        ...
        getContentPane().add(panelSuperior, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 660, 40));

        PanelLogin.setBackground(new java.awt.Color(255, 255, 255));
        PanelLogin.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        PanelLogin.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jlbContrasena.setBackground(new java.awt.Color(238, 112, 82));
        jlbContrasena.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jlbContrasena.setForeground(new java.awt.Color(238, 112, 82));
        jlbContrasena.setText("Contraseña:");
        PanelLogin.add(jlbContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 110, 40));

        jlbIconoUsrG.setBackground(new java.awt.Color(238, 112, 82));
        jlbIconoUsrG.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jlbIconoUsrG.setForeground(new java.awt.Color(238, 112, 82));
        jlbIconoUsrG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_User_96px_2.png"))); // NOI18N
        PanelLogin.add(jlbIconoUsrG, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 50, 100, 90));

        jlbiconoPassw.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_Key_32px.png"))); // NOI18N
        PanelLogin.add(jlbiconoPassw, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 40, 30));
        ...
        jlbiconoUserC.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_customer_32px_1.png"))); // NOI18N
        PanelLogin.add(jlbiconoUserC, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 50, 30));

        jtfUSR.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jtfUSR.setForeground(new java.awt.Color(153, 153, 153));
        jtfUSR.setBorder(null);
        jtfUSR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtfUSRActionPerformed(evt);
            }
        });
        PanelLogin.add(jtfUSR, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 180, 30));

        jpwPSW.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jpwPSW.setForeground(new java.awt.Color(153, 153, 153));
        jpwPSW.setBorder(null);
        jpwPSW.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jpwPSWActionPerformed(evt);
            }
        });
        PanelLogin.add(jpwPSW, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, 200, 30));

        separadorContrasena.setBackground(new java.awt.Color(0, 0, 0));
        separadorContrasena.setText("---------------------------------");
        PanelLogin.add(separadorContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 220, 10));

        jLabel2.setBackground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("--------------------------------");
        PanelLogin.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 220, 10));

        jlbUsuario.setBackground(new java.awt.Color(238, 112, 82));
        jlbUsuario.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jlbUsuario.setForeground(new java.awt.Color(238, 112, 82));
        jlbUsuario.setText("Usuario:");
        PanelLogin.add(jlbUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 110, 40));
        ...
        jbnFACTURA.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FACTURA.png"))); // NOI18N
        ...
        jbnEntrar.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jbnEntrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/botonsito.png"))); // NOI18N
        jbnEntrar.setBorder(null);
        jbnEntrar.setContentAreaFilled(false);
        jbnEntrar.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jbnEntrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbnjbnEntrarActionPerformed(evt);
            }
        });
        PanelLogin.add(jbnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 319, 130, -1));
        ...
        PanelLogin.add(fondoColor, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -440, 260, 450));
        ...
        getContentPane().add(PanelLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 440));

        Menu.setBackground(new java.awt.Color(255, 255, 255));
        Menu.setDesktopManager(null);
        Menu.setDragMode(javax.swing.JDesktopPane.OUTLINE_DRAG_MODE);
        ...
        Menu.add(logoAngel);
        logoAngel.setBounds(0, 10, 630, 390);

        getContentPane().add(Menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 40, 660, 400));
    ...
    private void jtfUSRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfUSRActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtfUSRActionPerformed

    private void jpwPSWActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jpwPSWActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jpwPSWActionPerformed
    ...
    private void jbnjbnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnjbnEntrarActionPerformed
   
    }//GEN-LAST:event_jbnjbnEntrarActionPerformed

 

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public static final javax.swing.JDesktopPane Menu = new javax.swing.JDesktopPane();
    public javax.swing.JPanel PanelLogin;
    private javax.swing.JLabel bienvenido;
    public javax.swing.JLabel fondoColor;
    private javax.swing.JLabel fondoColor2;
    ...
    public javax.swing.JLabel jlbIconoUsrG;
    ...
    public javax.swing.JLabel jlbiconoPassw;
    public javax.swing.JLabel jlbiconoUserC;
    private javax.swing.JPanel jpIngreso;
    public javax.swing.JPasswordField jpwPSW;
    private javax.swing.JTextField jtfContrasena;
    public javax.swing.JTextField jtfUSR;
    private javax.swing.JTextField jtfUsuario;
    public javax.swing.JLabel logoAngel;
    public javax.swing.JLabel menu;
    private javax.swing.JPanel panelSuperior;
    public javax.swing.JLabel separadorContrasena;
